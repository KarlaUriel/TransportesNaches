document.addEventListener("DOMContentLoaded", function () {
    ...
    // Simulación del rol del usuario (ajusta según tu lógica de autenticación)
    const userRole = localStorage.getItem("userRole") || "Administrador"; // Asegúrate de obtener el rol real
    ...
    function inicializar() {
        ...
        // Deshabilitar el select si el usuario no es administrador
        selectRol.disabled = userRole !== "Administrador";
    }
    ...
    function cargarDetalleOperador(idOperador) {
        ...
        // Establecer el valor del select según el rol del usuario
        selectRol.value = usuario.rol || 'Operador'; // Valor por defecto: Operador
        // Habilitar/deshabilitar el select según el rol del usuario
        selectRol.disabled = userRole !== "Administrador";
    ...
    async function guardarOperador() {
        const operadorData = {
            ...
            Usuario: {
                ...
                rol: selectRol.value, // Usar el valor del select
                activoUsuario: 1
            },
            activoOperador: 1
        };
    ...
    function limpiarMostrarFormulario() {
        limpiarFormulario();
        // Habilitar el select solo si el usuario es administrador
        selectRol.disabled = userRole !== "Administrador";
        setDetalleVisible(true);
    }
    ...
    function limpiarFormulario() {
        ...
        selectRol.value = 'Operador'; // Establecer valor por defecto
    }
