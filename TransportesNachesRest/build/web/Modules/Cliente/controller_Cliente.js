document.addEventListener("DOMContentLoaded", function () {
    ...
    async function cargarDetalleCliente(idCliente) {
        ...
        document.getElementById("minLocal").value = cliente.minComisionLocal || '';
        document.getElementById("maxLocal").value = cliente.maxComisionLocal || '';
        document.getElementById("minForaneo").value = cliente.minComisionForaneo || '';
        document.getElementById("maxForaneo").value = cliente.maxComisionForaneo || '';
    ...
    async function guardarCliente() {
        ...
        const clienteData = {
            ...
            minComisionLocal: document.getElementById("minLocal").value.trim() || null,
            maxComisionLocal: document.getElementById("maxLocal").value.trim() || null,
            minComisionForaneo: document.getElementById("minForaneo").value.trim() || null,
            maxComisionForaneo: document.getElementById("maxForaneo").value.trim() || null,
            activoCliente: 1
        };
