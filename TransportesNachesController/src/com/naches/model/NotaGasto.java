...
public class NotaGasto {
    ...
    public Date getFechaLlenado() { return fechaLlenado; }
    public void setFechaLlenado(Date fechaLlenado) { this.fechaLlenado = fechaLlenado; }
    ...
    public double getKmInicio() { return kmInicio; }
    public void setKmInicio(double kmInicio) { this.kmInicio = kmInicio; }
    public double getKmFinal() { return kmFinal; }
    public void setKmFinal(double kmFinal) { this.kmFinal = kmFinal; }
    public int getNoEntrega() { return noEntrega; }
    public void setNoEntrega(int noEntrega) { this.noEntrega = noEntrega; }
    public boolean isGasolinaInicio() { return gasolinaInicio; }
    public void setGasolinaInicio(boolean gasolinaInicio) { this.gasolinaInicio = gasolinaInicio; }
    public String getGasolinaLevel() { return gasolinaLevel; }
    public void setGasolinaLevel(String gasolinaLevel) { this.gasolinaLevel = gasolinaLevel; }
    public boolean isLlantasInicio() { return llantasInicio; }
    public void setLlantasInicio(boolean llantasInicio) { this.llantasInicio = llantasInicio; }
    public boolean isAceiteInicio() { return aceiteInicio; }
    public void setAceiteInicio(boolean aceiteInicio) { this.aceiteInicio = aceiteInicio; }
    public boolean isAnticongelanteInicio() { return anticongelanteInicio; }
    public void setAnticongelanteInicio(boolean anticongelanteInicio) { this.anticongelanteInicio = anticongelanteInicio; }
    public boolean isLiquidoFrenosInicio() { return liquidoFrenosInicio; }
    public void setLiquidoFrenosInicio(boolean liquidoFrenosInicio) { this.liquidoFrenosInicio = liquidoFrenosInicio; }
    public String getComentarioEstado() { return comentarioEstado; }
    public void setComentarioEstado(String comentarioEstado) { this.comentarioEstado = comentarioEstado; }
    public String getFotoTablero() { return fotoTablero; }
    public void setFotoTablero(String fotoTablero) { this.fotoTablero = fotoTablero; }
    public String getFotoAcuse() { return fotoAcuse; }
    public void setFotoAcuse(String fotoAcuse) { this.fotoAcuse = fotoAcuse; }
    ...
    public String getNoFact() { return noFact; }
    public void setNoFact(String noFact) { this.noFact = noFact; }
    ...
    public NotaGasto(int idNota, String estadoFact, Date fechaLlenado) {
        this.idNota = idNota;
